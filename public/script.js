// VERSÃO FINAL - DETETIVE DE NOMES APRIMORADO
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  appId: "1:66122858261:web:7fa21f1805463b5c08331c"
    ...
    const CASA_ESPIRITA_LAT = -22.75553, CASA_ESPIRITA_LON = -47.36945, RAIO_EM_METROS = 50;
    ...
    async function inscreverParaNotificacoes() { /* ...código sem alteração... */ }
    async function carregarHistoricoDoVoluntario(nome) { /* ...código sem alteração... */ }
    function handleCheckboxChange() { /* ...código sem alteração... */ }
    async function buscarAtividadesDoFirestore() { /* ...código sem alteração... */ }
    function criarCheckboxesDeAtividade() { /* ...código sem alteração... */ }
    function getDistance(lat1, lon1, lat2, lon2) { /* ...código sem alteração... */ }
    async function atualizarPresenca(novoStatus) { /* ...código sem alteração... */ }
    function checarLocalizacao() { /* ...código sem alteração... */ }
    function mostrarTelaDeStatus() { /* ...código sem alteração... */ }
    if (btnSair) { /* ...código sem alteração... */ }
    if (btnVerHistorico) { /* ...código sem alteração... */ }
    if (btnAtivarNotificacoes) { /* ...código sem alteração... */ }
    async function carregarMural() { /* ...código sem alteração... */ }
